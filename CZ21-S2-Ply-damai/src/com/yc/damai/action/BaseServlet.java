 ...
 * url: /msg.s
 * 
 * 规则1： 使用op请求参数区分不同操作类型 请求： 发布留言： /msg.s?op=add 查询留言: /msg.s?op=query 回复留言
 * /msg.s?op=reply .... 规则2：定义不同业务方法对应处理不同的请求， 用方法名和 op 值对应 public void add(...)
 * ==> op=add public void query(...) ==> op=query
 * 
 * BaseServlet 是一个共同父类， 业务方法写在子类中 java 黑科技 —— 反射
 * 
 */
...
public abstract class BaseServlet extends HttpServlet {
	 ...
	 * @throws IOException
	 */
	public void append(HttpServletResponse response, Object obj) throws IOException {
		Gson gson = new Gson();
